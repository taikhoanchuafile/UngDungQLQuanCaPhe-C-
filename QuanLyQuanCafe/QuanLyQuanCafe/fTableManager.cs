...
namespace QuanLyQuanCafe
{
    public partial class fTableManager : Form
    {
       ...
       // {
       //   List<Category> listCategory = CategoryDAO.Instance.GetCategoryByID(id);
       //     cbCategory.DataSource = listCategory;
       //     cbCategory.DisplayMember = "name";
       // }
        ...
        void f_UpdateAccount(object sender, QuanLyQuanCafe.fAccountProfile.AccountEvent e)
        {
        ...
        void f_UpdateTable(object sender, EventArgs e)
        {
            ...
            if (flpTable.Tag != null)
                ShowBill((flpTable.Tag as Table).ID);
            LoadTable();
        }
        ...
        private void btnAddFood_Click(object sender, EventArgs e)
        {
            ...
            if(table == null)
            {
                MessageBox.Show("Hãy chọn bàn");//bàn
                return;
            }
         ...
         private void btnSwitchTable_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(string.Format("Bạn có thật sự muốn chuyển {0} qua {1} không?", (lsvBill.Tag as Table).Name, (cbSwitchTable.SelectedItem as Table).Name), "Thông báo", MessageBoxButtons.OKCancel) == DialogResult.OK)
