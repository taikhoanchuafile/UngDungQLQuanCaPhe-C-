...
namespace QuanLyQuanCafe.ADO
{
    public class BillInfoDAO
    {
        ...
        {
            DataProvider.Instance.ExcuteQuery("DELETE dbo.BillInfo WHERE idBill=" + id);
        }
        ...
        {
            DataProvider.Instance.ExecuteNonQuery("USP_InsertBillInfo @idBill , @idFood , @countT", new object[] { idBill,idFood,count });
        }
    }
}
