...
private  object id;
        ...
        public DataTable GetListBillByDateAndDate(DateTime checkIn, DateTime checkOut, int pageNum)
        {
            return DataProvider.Instance.ExcuteQuery("EXEC USP_GetListBillByDateAndDate @checkIn , @checkOut , @page", new object[] { checkIn, checkOut, pageNum });
        }
        public int GetNumBillListByDate(DateTime checkIn, DateTime checkOut)
        {
            return (int)DataProvider.Instance.ExcuteScalar("EXEC USP_GetNumBillListByDate @checkIn , @checkOut", new object[] { checkIn, checkOut });
        }
